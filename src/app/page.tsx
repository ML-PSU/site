    ...
    <div className="min-h-screen bg-cream">
      ...
      >
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4 w-full max-w-2xl">
            <a
              ...
              className="bg-gray-900 text-white px-6 py-3 rounded-full font-medium flex-1 min-w-[180px]
                       text-center font-bold hover:bg-gray-700 transition-colors
          ...
          <div className="flex flex-wrap justify-center gap-6 mt-2">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-800 underline hover:text-[#5865F2] transition-all duration-200 underline-offset-4"
            >
              Discord
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-800 underline hover:text-[#00AFF0] transition-all duration-200 underline-offset-4"
            >
              GroupMe
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-800 underline hover:text-[#9333ea] transition-all duration-200 underline-offset-4"
            >
              Calendar
            </a>
          </div>
        ...
        <MotionDiv
          ...
          variants={fadeIn}
        >
          <h2 className="text-4xl font-serif mb-12">Our Sponsors</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 max-w-2xl mx-auto">
            {sponsors.map((sponsor) => (
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center p-6 bg-white rounded-lg border border-gray-200 hover:border-red-600 hover:shadow-md transition-all"
              >
                <Image
                  src={sponsor.image}
                  alt={sponsor.name}
        ...
        <MotionDiv
          ...
          variants={fadeIn}
        >
          <h2 className="text-4xl font-serif mb-12 text-center">Upcoming Events</h2>
          <div className="w-full flex justify-center">
            <iframe
              src="https://lu.ma/embed/calendar/cal-3mrXkQHS4duefEd/events?lt=light"
              width="100%"
              height="450"
              style={{ border: '2px solid #e5e7eb', borderRadius: '12px' }}
              allowFullScreen
              aria-hidden="false"
              tabIndex={0}
            />
        ...
        >
          <h2 className="text-4xl font-serif mb-12 text-center">What We Are Offering</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Anthropic Credits Card */}
            <div className="bg-white rounded-xl overflow-hidden shadow-lg border border-gray-200 hover:shadow-xl hover:border-red-600 transition-all duration-300 hover:-translate-y-2 group">
              ...
              <div key={member.name} className="flex items-center gap-4">
                ...
                <div className="space-y-1">
                  <Link
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-lg text-gray-900 hover:text-red-600 transition-colors underline underline-offset-4"
                  >
                    {member.name}
                  </Link>
